<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"D:\phpStudy\PHPTutorial\WWW\jdshop\public/../application/admin\view\index\index.html";i:1635523661;}*/ ?>
<!DOCTYPE html>
<html>
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a class="J_menuItem" href="<?php echo url('category/index'); ?>"><i class="fa fa-amazon"></i> <span class="nav-label">分类管理</span></a>
                    </li>

                    <li>
                        <a class="J_menuItem" href="<?php echo url('goods/index'); ?>"><i class="fa fa-amazon"></i> <span class="nav-label">商品管理</span></a>
                    </li>

                    <li class="menu"> <a href="#">
                            <i class="fa fa-paste"></i>
                            <span class="nav-label">测试菜单二 </span>
                            <span class="fa arrow"></span>
                        </a>
                        <ul class="nav nav-second-level collapse" aria-expanded="false" style="height: 0px;">
                            <li> <a class="J_menuItem" href="<?php echo url('index'); ?>" data-index="0">子菜单</a> </li>
                        </ul>
                    </li>
                </ul>
            </div>
