<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"D:\phpStudy\PHPTutorial\WWW\jdshop\public/../application/admin\view\goods\index.html";i:1635540621;}*/ ?>
<!DOCTYPE html>
<html>
                            ...
                            <ul>
                                <li class="jstree-open">全部展开、折叠
                                    <ul>
                                        ...
                                        <li class="<?php echo $key==0?'jstree-open' : ''; ?>"><?php echo $vo['cat_name']; ?>
                                            <ul>
                                                ...
                                                <a class="<?php if(input('id',0) == $voson['id']): ?>jstree-clicked<?php endif; ?>" href="<?php echo url('content',['id'=>$voson['id']]); ?>"><?php echo $voson['cat_name']; ?></a>
                                                </li>
